...
if load_saved_values:
    ...
    shap_values_train, expected_logits = calculate_shap_values(xgb_model, X_train, num_features_to_use)
    shap_values_valid, _ = calculate_shap_values(xgb_model, X_valid, num_features_to_use)
    np.save('experiments/costa_rica/train_shap_values.npy', shap_values_train)
    np.save('experiments/costa_rica/expected_logits.npy', expected_logits)
    np.save('experiments/costa_rica/valid_shap_values.npy', shap_values_valid)
